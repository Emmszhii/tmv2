...
import { getReferralSourceCountRecord } from "./functions-referral-source";

const ReferralSourceTable = ({ setItemEdit }) => {
  ...
  const {
    ...
    `/v2/controllers/developer/settings/referral-source/referral-source.php`,
    "get",
  ...
  return (
    <>
      <div className="table__wrapper relative rounded-md shadow-md overflow-auto mb-8">
        ...
        <RecordCount
          record={referralSource?.data.length}
          status={getReferralSourceCountRecord(referralSource)}
        />
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            {(isLoading || referralSource?.data.length === 0) && (
      ...
      {store.isConfirm && (
        <ModalConfirm
          mysqlApiArchive={`/v2/controllers/developer/settings/referral-source/active.php?referralSourceId=${id}`}
      ...
      {store.isRestore && (
        <ModalDeleteAndRestore
          id={id}
          isDel={isDel}
          mysqlApiDelete={`/v2/controllers/developer/settings/referral-source/referral-source.php?referralSourceId=${id}`}
          mysqlApiRestore={`/v2/controllers/developer/settings/referral-source/active.php?referralSourceId=${id}`}
          msg={
            isDel
