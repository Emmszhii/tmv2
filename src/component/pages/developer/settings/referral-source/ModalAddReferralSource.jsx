...
const ModalAddReferralSource = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `/v2/controllers/developer/settings/referral-source/referral-source.php?referralSourceId=${itemEdit.referral_source_aid}` //update
          : "/v2/controllers/developer/settings/referral-source/referral-source.php", //add
        itemEdit ? "put" : "post",
        values
      ),
    onSuccess: (data) => {
