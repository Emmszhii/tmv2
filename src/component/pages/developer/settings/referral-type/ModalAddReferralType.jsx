...
const ModalAddReferralType = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `/v2/controllers/developer/settings/referral-type/referral-type.php?referralTypeId=${itemEdit.referral_type_aid}` //update
          : "/v2/controllers/developer/settings/referral-type/referral-type.php", //add
        itemEdit ? "put" : "post",
        values
      ),
    onSuccess: (data) => {
