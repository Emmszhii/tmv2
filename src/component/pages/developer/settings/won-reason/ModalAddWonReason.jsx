...
const ModalWonReason = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `/v2/controllers/developer/settings/won-reason/won-reason.php?wonReasonId=${itemEdit.won_reason_aid}` //update
          : "/v2/controllers/developer/settings/won-reason/won-reason.php", //add
        itemEdit ? "put" : "post",
        values
      ),
    onSuccess: (data) => {
