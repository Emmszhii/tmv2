...
const ModalAddSystem = ({ itemEdit }) => {
  ...
  const mutation = useMutation({
    mutationFn: (values) =>
      queryData(
        itemEdit
          ? `/v2/controllers/developer/settings/system/system.php?systemId=${itemEdit.settings_system_aid}` //update
          : "/v2/controllers/developer/settings/system/system.php", //add
        itemEdit ? "put" : "post",
        values
      ),
    onSuccess: (data) => {
